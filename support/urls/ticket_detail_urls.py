...
urlpatterns = [
    ...
    path('api/v1/ticket_detail/get_all_by_ticket_id/<int:ticket_id>',
         views.getAllTicketDetailByTicketId),
    ...
    path('api/v1/ticket_detail/message_to_members',
         views.createMessageToAllMember),
