...
# from donation.serializers import UserMinimalSerializer
...
class TicketDepartmentMinimalSerializer(serializers.ModelSerializer):
    class Meta:
        model = TicketDepartment
        fields = '__all__'


class TicketPriorityMinimalSerializer(serializers.ModelSerializer):
    class Meta:
        model = TicketPriority
        fields = '__all__'


class TicketStatusMinimalSerializer(serializers.ModelSerializer):
    class Meta:
        model = TicketStatus
        fields = '__all__'
...
class TicketListSerializer(serializers.ModelSerializer):
    ...
    ticket_department = TicketDepartmentMinimalSerializer()
    ticket_priority = TicketPriorityMinimalSerializer()
    ticket_status = TicketStatusMinimalSerializer()
...
class TicketDetailListSerializer(serializers.ModelSerializer):
    ...
    admin = AdminUserMinimalListSerializer()
    # customer = UserMinimalSerializer()
...
class MessageListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Message
        fields = ['id', 'sender', 'receiver', 'sender_image', 'receiver_image',
                  'file', 'message', 'created_at', 'updated_at', 'created_by', 'updated_by']
        extra_kwargs = {
            'created_at': {
                'read_only': True,
            },
