...
class Ticket(models.Model):
    ...
    ticket_type = models.CharField(max_length=200, null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class ToDoTask(models.Model):
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.RESTRICT, related_name='user_todo_tasks')
    task_type = models.ForeignKey(
        TaskType, on_delete=models.CASCADE, related_name='type_todo_task')
