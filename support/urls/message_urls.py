...
urlpatterns = [
    ...
    path('api/v1/message/get_all_senders_with_unseen_message_count_by_receiver_id/<int:receiver_id>',
         views.getAllSendersWithUnseenMessageCount),

    path('api/v1/message/get_all_by_sender_id/<int:sender_id>',
         views.getAllMessageBySenderId),
